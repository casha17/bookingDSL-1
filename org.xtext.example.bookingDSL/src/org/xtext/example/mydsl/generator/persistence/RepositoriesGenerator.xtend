...
class RepositoriesGenerator {
		...
		Resource resource)
	{
		...
		genUserRepo(fsa, resource, systemName)
		
	}
	
	private static def void genUserRepo(IFileSystemAccess2 fsa,
		Resource resource, String systemName){
			fsa.generateFile('''«systemName»/«systemName»/Persistence/Repositories/UserRepository.cs''', 
				'''
				using System;
